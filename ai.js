...
export const getTasks = async (projectDetails) => {
  try {
    ...
    return [response.choices[0].message.content, projectDetails.project, techStack];
  } catch (error) {
    console.error(error)
    return 0
  }
