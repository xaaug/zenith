  ...
  "tasks": [
    {
      ...
      "time": 90,
      "description": "Install Node.js and create a new React app using npx create-react-app.",
    ...
    },
    {
      ...
      "time": 60,
      "description": "Create a Firebase project, enable authentication (e.g., Google sign-in), and integrate it with the React app.",
    ...
    },
    {
      ...
      "time": 180,
      "description": "Set up a Node.js server with WebSockets to enable real-time code editing collaboration.",
